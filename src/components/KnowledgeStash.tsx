      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-bold text-black font-['Press_Start_2P'] 
            ...
            const cardContent = (
              <div className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <ExternalLink className={`h-4 w-4 text-gray-700 transition-opacity
                                          ${isClickable ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
                </div>
                
                {/* Title */}
                <h3 className="text-base md:text-lg font-bold mb-4 text-black font-['Press_Start_2P'] 
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 font-['Jersey_25'] tracking-wide">RARITY</span>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div className="retro-border p-4 bg-white text-center border-2 border-black transition-all duration-150 ease-in-out cursor-pointer
              ...
              <div className="text-sm text-gray-600 font-['Jersey_25'] tracking-wide">TOTAL</div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center space-x-4">
              ...
              <span className="text-lg font-bold text-black font-['Press_Start_2P'] tracking-wider">
