    ...
    <div className="retro-border p-8 bg-card mb-8">
      <div className="mb-6">
        <div className="flex flex-wrap items-center gap-2 mb-4">
          <h2 className="text-xl md:text-2xl font-bold text-black font-['Press_Start_2P'] 
                         tracking-wider leading-relaxed">
            SEND MESSAGE
          </h2>
          <span className="text-base md:text-lg text-gray-700 font-['Jersey_25'] tracking-wide">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="retro-border w-full p-4 text-base font-['Jersey_25'] bg-white text-black 
                       focus:bg-gray-50 outline-none transition-colors tracking-wide
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="retro-border w-full p-4 text-base font-['Jersey_25'] bg-white text-black 
                       focus:bg-gray-50 outline-none transition-colors resize-none tracking-wide
                       focus:border-green-400"
