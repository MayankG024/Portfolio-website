      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-3 sm:px-6 py-6 sm:py-12 pb-12 sm:pb-24 relative z-10">
        ...
        >
          <div className="text-left mb-4">
            <span className="text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide leading-relaxed text-black">
              {headerText}
              {showHeaderCursor && headerText.length < headerIntroText.length && <span className="typewriter-cursor">█</span>}
            </span>
          </div>
          <div className={`text-[6px] sm:text-[8px] md:text-[10px] font-mono leading-tight whitespace-pre tracking-wide transition-opacity duration-500 overflow-x-auto text-black ${
...
`}
        ...
        >
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 sm:mb-6 font-['Press_Start_2P'] 
                         tracking-wider leading-relaxed text-black">
            {currentText}
          ...
          <div className="text-lg sm:text-xl md:text-2xl tracking-wider 
                          leading-relaxed space-y-4 sm:space-y-8 max-w-4xl mx-auto text-black">
        ...
        >
          <h2 className="text-base sm:text-lg md:text-xl font-bold mb-6 sm:mb-8 font-['Press_Start_2P'] 
                         tracking-wider leading-relaxed text-black">MAIN MENU</h2>
            ...
            <div className="retro-border p-4 bg-background hover:bg-green-900/20 transition-colors duration-300">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3 space-y-2 sm:space-y-0">
                <div className="flex-1 text-left">
                  ...
                  <p className="font-['Jersey_25'] tracking-wide text-base sm:text-lg text-left text-black">
                    INDEPENDENT
                  </p>
                </div>
                <div className="text-left sm:text-right sm:flex-shrink-0">
                  <div className="font-['Jersey_25'] text-sm sm:text-base tracking-wide text-black">
                    FEB 2025 - PRESENT
                  </div>
        ...
        >
          <h2 className="text-base sm:text-lg md:text-xl font-bold mb-6 sm:mb-8 font-['Press_Start_2P'] 
                         tracking-wider leading-relaxed text-black">SKILLS ACQUIRED</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="ml-3 sm:ml-6 space-y-2">
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Java</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Python</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">JavaScript</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">SQL</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="ml-3 sm:ml-6 space-y-2">
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">HTML/CSS</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">React</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Next JS</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Framer Motion</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="ml-3 sm:ml-6 space-y-2">
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">PostGres</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Spring Boot</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Node.js</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Express</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="ml-3 sm:ml-6 space-y-2">
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">AI Agents</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Git</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Docker</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">MySQL</div>
                <div className="retro-border px-2 sm:px-3 py-1 sm:py-2 text-sm sm:text-lg md:text-xl font-['Jersey_25'] tracking-wide bg-white text-black">Postman</div>
              </div>
            </div>
