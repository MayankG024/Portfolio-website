      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-3 sm:px-6 py-6 sm:py-12 pb-12 sm:pb-24 relative z-10">
        <div className="max-w-4xl w-full text-center space-y-8 sm:space-y-16">
          ...
          >
            ...
            <div className={`hidden sm:block text-[8px] md:text-[10px] font-mono leading-tight whitespace-pre tracking-wide transition-opacity duration-500 overflow-x-auto text-foreground ${asciiVisible ? 'opacity-100' : 'opacity-0'
              }`}>
              {`
    ███╗   ███╗ █████╗ ██╗   ██╗ █████╗ ███╗   ██╗██╗  ██╗     ██████╗ ██╗   ██╗██████╗ ████████╗ █████╗ 
    ████╗ ████║██╔══██╗╚██╗ ██╔╝██╔══██╗████╗  ██║██║ ██╔╝    ██╔════╝ ██║   ██║██╔══██╗╚══██╔══╝██╔══██╗
...
`}
            ...
            <div
              ref={asciiWrapperRef}
              className={`sm:hidden mobile-ascii-wrapper transition-opacity duration-500 ${asciiVisible ? 'opacity-100' : 'opacity-0'
                }`}
