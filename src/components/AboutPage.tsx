      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="retro-border p-8 bg-card">
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <p className="font-['Press_Start_2P'] text-gray-500 text-xs tracking-wider leading-relaxed">
                    (Don't come close)
                  </p>
                </div>
                ...
                >
                  <p className="font-['Press_Start_2P'] text-black text-sm tracking-wider leading-relaxed">
                    I AM BATMAN !!
                  </p>
                </div>
              </div>
            ...
            <div className="retro-border p-6 bg-card">
              <h2 className="text-lg font-bold mb-4 text-black font-['Press_Start_2P'] 
                             tracking-wider leading-relaxed">CURRENT STATS</h2>
              <div className="space-y-4">
                   <div className="flex justify-between items-center">
                  <span className="font-['Jersey_25'] text-gray-600 tracking-wide text-lg">EDUCATION</span>
                  <span className="font-['Jersey_25'] text-green-600 tracking-wide text-lg">DIT University</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-['Jersey_25'] text-gray-600 tracking-wide text-lg">LOCATION</span>
                  <span className="font-['Jersey_25'] text-green-600 tracking-wide text-lg">Dehradun, India</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-['Jersey_25'] text-gray-600 tracking-wide text-lg">AGE</span>
                  <span className="font-['Jersey_25'] text-green-600 tracking-wide text-lg">22</span>
                </div>
             
                <div className="flex justify-between items-center">
                  <span className="font-['Jersey_25'] text-gray-600 tracking-wide text-lg">STATUS</span>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="space-y-6 text-lg md:text-xl text-black font-['Jersey_25'] 
                             leading-relaxed tracking-wide">
                <p>
                ...
                {experience.map((job, index) => (
                  <div key={index} className="retro-border p-4 bg-background hover:bg-green-900/20 
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="font-['Press_Start_2P'] text-black text-base mb-2 tracking-wider">
                          {job.role}
                        </h3>
                        <p className="font-['Jersey_25'] text-gray-600 tracking-wide text-lg">
                          {job.company}
                        </p>
                      </div>
                      <div className="text-right">
                        <div className="font-['Jersey_25'] text-gray-600 text-base tracking-wide">
                          {job.period}
                        </div>
        ...
        >
          <div className="text-center space-y-4">
            <p className="text-base md:text-2xl font-['Jersey_25'] text-black tracking-wide leading-relaxed">
